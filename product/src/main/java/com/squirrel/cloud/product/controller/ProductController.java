...
import com.squirrel.cloud.product.VO.ProductInfoVO;
import com.squirrel.cloud.product.VO.ProductVO;
...
public class ProductController {
    ...
    public List<ProductInfo> getProductList(@RequestBody List<String> productList){
        List<ProductInfo> list =  productService.findByProductIdIn(productList);
        return list;
    }
